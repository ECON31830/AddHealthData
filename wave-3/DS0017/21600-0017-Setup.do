/**************************************************************************
 ...
 |       - the dictionary file
 |
 |  Then execute the do file (e.g., do 21600-0017-statasetup.do)
 |
 **************************************************************************/
...
label data "National Longitudinal Study of Adolescent to Adult Health (Add Health), 1994-2008 [Public Use], Wave III: Public Use Graduation Data"

#delimit ;
label define ERGRADM   1 "(1) January" 2 "(2) February" 3 "(3) March"
                       4 "(4) April" 5 "(5) May" 6 "(6) June" 7 "(7) July"
                       8 "(8) August" 9 "(9) September" 10 "(10) October"
                       11 "(11) November" 12 "(12) December"
                       92 "(92) No graduation month recorded on transcript" ;
label define ERGRADY
                       9992 "(9992) No graduation year recorded on transcript" ;
