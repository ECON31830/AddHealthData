/**************************************************************************
 ...
 |       - the dictionary file
 |
 |  Then execute the do file (e.g., do 21600-0020-statasetup.do)
 |
 **************************************************************************/
...
format AH_RAW %3.0f
format PVTPCT3 %3.0f
format PVTSTD3C %3.0f
format PVTSTD3L %3.0f
format PVTPCT1C %3.0f
format PVTPCT1L %3.0f
format PVTSTD1 %3.0f
...
label data "National Longitudinal Study of Adolescent to Adult Health (Add Health), 1994-2008 [Public Use], Wave III: Peabody Picture Vocabulary Test (PVT), Public Use"

#delimit ;
label define AH_RAW    996 "(996) Refused" ;
label define PVTPCT3   996 "(996) Refused" ;
label define PVTSTD3C  996 "(996) Refused" ;
label define PVTSTD3L  996 "(996) Refused" ;
